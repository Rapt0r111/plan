...
import { DissolveParticles } from "@/shared/ui/animations/particles";
  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none overflow-visible" style={{ zIndex: 20 }}>
        {/* ✅ ИСПРАВЛЕНО: active → visible (интерфейс DissolveParticlesProps из particles.tsx) */}
        <DissolveParticles visible={showParticles} />
      </div>
