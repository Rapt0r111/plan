...
export const ROLE_META: Record<Role, RoleMeta> = {
  company_commander: {
    role: "company_commander", label: "Командир роты", short: "КНР",
    bgClass: "bg-violet-100", textClass: "text-violet-800", borderClass: "border-violet-300", hex: "#7c3aed"
  },
  platoon_1_commander: {
    role: "platoon_1_commander", label: "Командир 1 взвода", short: "КВ1",
    bgClass: "bg-teal-100", textClass: "text-teal-800", borderClass: "border-teal-300", hex: "#0d9488"
  },
  platoon_2_commander: {
    role: "platoon_2_commander", label: "Командир 2 взвода", short: "КВ2",
    bgClass: "bg-emerald-100", textClass: "text-emerald-800", borderClass: "border-emerald-300", hex: "#059669"
  },
  deputy_platoon_1: {
    role: "deputy_platoon_1", label: "Зам. ком. 1 взв.", short: "ЗКВ1",
    bgClass: "bg-blue-100", textClass: "text-blue-800", borderClass: "border-blue-300", hex: "#2563eb"
  },
  deputy_platoon_2: {
    role: "deputy_platoon_2", label: "Зам. ком. 2 взв.", short: "ЗКВ2",
    bgClass: "bg-blue-100", textClass: "text-blue-800", borderClass: "border-blue-300", hex: "#2563eb"
  },
  squad_commander_2: {
    role: "squad_commander_2", label: "КО 2 отд.", short: "КО2",
    bgClass: "bg-zinc-100", textClass: "text-zinc-800", borderClass: "border-zinc-300", hex: "#71717a"
  },
  sergeant_major: {
