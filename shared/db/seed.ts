...
// ─── ЭПИКИ ────────────────────────────────────────────────────────────────────
const EPIC_SEEDS = [
  { title: "Январь", description: "Подготовка к проверкам, стрельбы, Присяга.", color: "#6366f1", startDate: "2026-01-01", endDate: "2026-01-31" },
  { title: "Февраль", description: "Проверка МОРФ, конкурс ГУС, агитация.", color: "#8b5cf6", startDate: "2026-02-01", endDate: "2026-02-28" },
  { title: "Март", description: "II этап конкурса ГУС, увольнение.", color: "#a855f7", startDate: "2026-03-01", endDate: "2026-03-31" },
  { title: "Апрель", description: "Проверка ВНК Q1, конкурс НЦУО.", color: "#ec4899", startDate: "2026-04-01", endDate: "2026-04-30" },
  { title: "Май", description: "Майские праздники, МВТФ Армия.", color: "#f43f5e", startDate: "2026-05-01", endDate: "2026-05-31" },
  { title: "Июнь", description: "Проверки ЗГТ, сдача МНИ.", color: "#f97316", startDate: "2026-06-01", endDate: "2026-06-30" },
  { title: "Июль", description: "МВТФ, проверка ВНК Q2, приём пополнения.", color: "#eab308", startDate: "2026-07-01", endDate: "2026-07-31" },
  { title: "Август", description: "Стрельбы, агитация, Присяга.", color: "#22c55e", startDate: "2026-08-01", endDate: "2026-08-31" },
  { title: "Сентябрь", description: "Проверки, агитация, увольнение.", color: "#14b8a6", startDate: "2026-09-01", endDate: "2026-09-30" },
  { title: "Октябрь", description: "Проверка ВНК Q3.", color: "#06b6d4", startDate: "2026-10-01", endDate: "2026-10-31" },
  { title: "Ноябрь", description: "Увольнение, приём МП, круглый стол.", color: "#3b82f6", startDate: "2026-11-01", endDate: "2026-11-30" },
  { title: "Декабрь", description: "Приём МП, инвентаризация, Новый год.", color: "#64748b", startDate: "2026-12-01", endDate: "2026-12-31" },
];
